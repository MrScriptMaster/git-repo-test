...
test_string="  aaa   "
echo "Before ${#test_string}: |${test_string}|"
trim test_string $test_string
echo "After ${#test_string}: |${test_string}|"

echo "Trimming: variant 2"
test_string="  aaa   "
echo "Before ${#test_string}: |${test_string}|"
test_string="${test_string#"${test_string%%[![:space:]]*}"}" && test_string="${test_string%"${test_string##*[![:space:]]}"}"
echo "After ${#test_string}: |${test_string}|"
